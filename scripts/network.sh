function f_network {
  ...
  sudo sed -i 's/net.ipv4.conf.all.send_redirects = 1/net.ipv4.conf.all.send_redirects = 0/' /etc/sysctl.conf
  sudo sed -i 's/net.ipv4.conf.default.send_redirects = 1/net.ipv4.conf.default.send_redirects = 0/' /etc/sysctl.conf
  ...
  sudo sed -i 's/net.ipv4.icmp_ignore_bogus_error_responses = 0/net.ipv4.icmp_ignore_bogus_error_responses = 1/' /etc/sysctl.conf
  
  sudo sed -i 's/net.ipv4.conf.all.accept_redirects = 1/net.ipv4.conf.all.accept_redirects = 0/' /etc/sysctl.conf
  sudo sed -i 's/net.ipv6.conf.all.accept_redirects = 1/net.ipv6.conf.all.accept_redirects = 0/' /etc/sysctl.conf
  sudo sed -i 's/net.ipv4.conf.default.accept_redirects = 1/net.ipv4.conf.default.accept_redirects = 0/' /etc/sysctl.conf
  sudo sed -i 's/net.ipv6.conf.default.accept_redirects = 1/net.ipv6.conf.default.accept_redirects = 0/' /etc/sysctl.conf
